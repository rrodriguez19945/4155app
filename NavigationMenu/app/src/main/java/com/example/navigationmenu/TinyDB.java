...
public class TinyDB {
    ...
    public ArrayList<Object> getListObject(String key, ArrayList<ExampleEventItems> mClass){
    	Gson gson = new Gson();
...
//    }
    ...
    public void putListObject(String key, ArrayList<ExampleEventItems> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
